...
def render_frontmatter(
    *, title: str, research_topic: str, research_slug: str, research_depth: int,
    research_generated: str, research_model: str, extra: dict | None = None,
) -> str:
...
def render_callout(topic: str, generated_at: str, n_sources: int) -> str:
    plural = "s" if n_sources != 1 else ""
    return (
        "> [!info] Machine-written\n"
        f"> Generated by researchd from {n_sources} source{plural}, "
        f"researching **{topic}**, on {generated_at}. Verify before "
